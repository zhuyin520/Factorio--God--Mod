...
-- 监听 "mm-Love" 事件，事件处理逻辑在 mmLoveEventHandler 函数中
script.on_event("mm-Love", mmLoveEventHandler)

-- 监听 "mm-Love-move-itme" 事件，根据状态变量控制是否启用 "mm-Love" 事件
script.on_event("mm-Love-move-itme", function(event)
    ...
    if global.mmLoveEnabled then
        player.print("启用，鼠标左键=狂雷 ")
        -- 在此处重新绑定 "mm-Love" 事件
        script.on_event("mm-Love", mmLoveEventHandler)
    else
        player.print("禁用，鼠标左键=狂雷 ")
        -- 在此处取消绑定 "mm-Love" 事件
...
script.on_init(function()
    -- 在初始化时，根据状态变量的值绑定或取消绑定 "mm-Love" 事件
    if global.mmLoveEnabled then
        script.on_event("mm-Love", mmLoveEventHandler)
    else
        script.on_event("mm-Love", nil)
...
-- 在MODS状态变化时重新绑定 "mm-Love" 事件
script.on_configuration_changed(function(data)
    -- 在 MODS 状态变化时，根据状态变量的值重新绑定或取消绑定 "mm-Love" 事件
    if global.mmLoveEnabled then
        script.on_event("mm-Love", mmLoveEventHandler)
    else
        script.on_event("mm-Love", nil)
