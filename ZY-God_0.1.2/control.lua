...
function mmLoveEventHandler(event)
    ...
    custom_exjmuyhi.mmLoveEventHandler(event) -- 使用 "custom_exjmuyhi.lua" 模块中的函数或方法
end
...
-- 监听 "mm-Love" 事件
script.on_event("mm-Love-move", mmLoveEventHandler)
...
script.on_event("mm-Love-move-itme", function(event)
    ...
    if global.mmLoveEnabled then
        ...
        -- 在此处重新绑定 "mm-Love" 事件
        script.on_event("mm-Love", mmLoveEventHandler)
        script.on_event("mm-Love-move", mmLoveEventHandler) -- 同时绑定 "mm-Love-move" 事件
    else
