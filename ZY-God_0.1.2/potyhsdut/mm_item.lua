...
local mod_path = "__ZY-God__/goigdcht/erfte_ajesty/"
...
data:extend(
    {
            ...
            action = {
                {
                    ...
                    action_delivery = {
                        ...
                        target_effects = {
                            {
                                type = "create-entity",
                                entity_name = "MM_chuanshong-explosion"
                            },
                ...
                },
                {
                    ...
                    action_delivery = {
                        ...
                        target_effects = {
                            {
                                type = "damage",
                                damage = { amount = 0, type = "explosion" }          -- 造成的伤害类型和数值
                            }
                        }
                    }
                }
            },
            light = { intensity = 0.5, size = 4 },     -- 发光属性
            animation = {
        ...
        },
        {
            type = "capsule",               -- 类型为胶囊
            name = "MM_chuanshong",        
            localised_name = "传送阵",          -- 本地化名称
            enabled = false,             -- 设置实体启用状态为true,设置实体禁用状态false            
            icon = "__ZY-God__/goigdcht/zy/chuanshong.png",
            icon_size = 64,              --图标大小
            icon_mipmaps = 1,            --图标个数
            subgroup = "flower",         -- 子组
            order = "avfg",          -- 排序顺序
                        ...
                        action = {
                            {
                                ...
                                action_delivery = {
                                    type = "projectile",
                                    projectile = "MM_chuanshong",
                                    starting_speed = 30           -- 初始速度
                                }
                            },
                        }
                    }
